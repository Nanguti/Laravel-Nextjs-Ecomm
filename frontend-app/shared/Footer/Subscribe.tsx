...
const Subscribe = () => {
  return (
    <div
      className="items-stretch justify-between space-y-5 rounded-2xl 
    bg-white/10 p-5 md:flex md:space-y-0"
    >
      <div className="basis-[52%] space-y-5">
        ...
        <Input
          ...
          rounded="rounded-lg"
          className="border-b-2 border-transparent border-b-neutral-400 bg-transparent
           placeholder:text-sm placeholder:text-neutral-200 focus:border-transparent"
