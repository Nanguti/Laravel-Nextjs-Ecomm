...
const NextPrev: FC<NextPrevProps> = ({
  ...
  return (
    <div className={`nc-NextPrev relative flex items-center ${className}`}>
      <button
        type="button"
        className={`${btnClassName} mr-2 flex items-center justify-center rounded-lg border ${
          focus === "left"
      ...
      <button
        type="button"
        className={`${btnClassName} flex items-center justify-center rounded-lg border ${
          focus === "right"
            ? "border-primary bg-primary text-white"
            : "border-slate-700"
        }`}
