  ...
  const renderTabsLocation = () => {
    return (
      <div className="relative flex flex-col space-y-4 py-8">
        ...
        <div
          className="mb-2 flex items-center gap-2 space-y-3 rounded-lg border 
        border-neutral-300 px-4 md:flex md:space-y-0"
        >
          ...
          <Input
            ...
            className="border-transparent bg-transparent placeholder:text-neutral-500 
